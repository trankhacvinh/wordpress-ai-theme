...
$ratio = sanitize_html_class(str_replace('/', '-', (string) pmedia_ai_section_value($pmedia_section, 'aspect_ratio', 'auto')));
...
<section <?php echo pmedia_ai_section_attrs($pmedia_section, 'pmedia-section pmedia-media-section'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
    <div class="pmedia-container">
        <figure class="pmedia-media pmedia-ratio-<?php echo esc_attr($ratio); ?> pmedia-object-<?php echo esc_attr($fit); ?>">
