 ...
 * Description: Core plugin for PMEDIA AI Blank Theme. Provides section builder, advanced nested components, global settings, custom code manager, no-key prompt workflow, sitemap site generator, custom post types, SEO fields and rendering helpers.
 * Version: 1.4.0
 * Author: PMEDIA
...
define('PMEDIA_AI_CORE_VERSION', '1.4.0');
