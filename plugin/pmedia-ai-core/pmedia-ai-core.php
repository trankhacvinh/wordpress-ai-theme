 ...
 * Description: Core plugin for PMEDIA AI Blank Theme. Provides section data, custom post types, SEO fields and rendering helpers.
 * Version: 1.0.0
 * Author: PMEDIA
...
define('PMEDIA_AI_CORE_VERSION', '1.0.0');
