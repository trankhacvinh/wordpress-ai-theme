 ...
 * Description: Core plugin for PMEDIA AI Blank Theme. Provides section builder, advanced nested components, design settings, global settings, custom code manager, no-key prompt workflow, sitemap site generator, custom post types, SEO fields and rendering helpers.
 * Version: 1.5.0
 * Author: PMEDIA
...
define('PMEDIA_AI_CORE_VERSION', '1.5.0');
...
require_once PMEDIA_AI_CORE_DIR . 'includes/class-pmedia-ai-component-registry.php';
...
require_once PMEDIA_AI_CORE_DIR . 'includes/class-pmedia-ai-design-settings.php';
require_once PMEDIA_AI_CORE_DIR . 'includes/class-pmedia-ai-custom-code.php';
